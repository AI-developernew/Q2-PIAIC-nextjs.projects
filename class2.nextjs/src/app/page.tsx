    ...
    return (
        <main>
            ...
            <section className="campus">
                ...
                <div className="row">
                    <div className="campus-col">
                        <Image src={"/assets/Campus1.png"} alt="1st image" width={332} height={221} />
                        <div className="layer">
                            <h3>DELHI</h3>
                        </div>
                    </div>
                    <div className="campus-col">
                        <Image src={"/assets/Campus2.png"} alt="2nd image" width={332} height={221} />
                        <div className="layer">
                            <h3>HYDERABAD</h3>
                        </div>
                    </div>
                    <div className="campus-col">
                        <Image src={"/assets/Campus3.png"} alt="3rd image" width={332} height={221} />
                        <div className="layer">
                            <h3>MUMBAI</h3>
                        </div>
                    </div>
            ...
            <section className="facilities">
                ...
                <div className="row">
                    <div className="facilities-col">
                        <Image src={"/assets/libary.png"} alt="" width={332} height={221} />
                        <h3>Best Libary</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio omnis asperiores atque aperiam.
                        </p>
                    </div>
                    <div className="facilities-col">
                        <Image src={"/assets/playground.png"} alt="" width={332} height={221} />
                        <h3>Athletics</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio omnis asperiores atque aperiam.
                        </p>
                    </div>
                    <div className="facilities-col">
                        <Image src={"/assets/food.png"} alt="" width={332} height={221} />
            ...
            <section className="testimonials">
                ...
                <div className="row">
                    <div className="testimonials-col">
                        <Image src={"/assets/user.png"} alt="oo.." width={332} height={221} />
                        <div>
            ...
            <section className="footer">
                ...
                <p>Made with <i className="fas fa-heart"></i> by <a href="index.html">Seerat Developer</a></p>
